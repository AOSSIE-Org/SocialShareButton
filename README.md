...
- ⚛️ Framework support: React, Next.js, Vue, Angular, WordPress, or plain HTML
...
No wrapper file is needed — integration is done via WordPress enqueueing APIs in your theme's `functions.php`.
