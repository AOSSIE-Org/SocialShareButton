...
- ⚛️ Framework support: React, Next.js, Vue, Angular, Rails, Django, Laravel, or plain HTML
...
<details>
<summary><b>🖥️ Rails / Django / Laravel</b></summary>

No wrapper file is needed — all three frameworks generate HTML on the server.
The integration pattern is identical: add CDN `<link>` and `<script>` tags to your base layout template.
